        ...
        $jsonButton.click(function () {
            $.ajax({
                ...
                success: function (data) {
                    var box = $(
                            '<div id="hotui_json_box"><textarea class="json">' +
                                data.replace(/  /g, '&nbsp;&nbsp;') +
                            '</textarea>' +
                    ...
                    box.children('.validate_button').click(function (e) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'template':
                                    JSON.stringify(template.toJSON(true))
                            },
                            success: function (data) {
                    ...
                    box.children('.update_button').click(function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                // Update textbox by closing and opening it
                                // again (this also re-retrieves the YAML)
